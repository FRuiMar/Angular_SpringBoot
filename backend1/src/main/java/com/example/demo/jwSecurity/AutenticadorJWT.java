...
public class AutenticadorJWT {
	...
	private static Key key = null; // Clave de encriptación que usaremos para generar el JWT. Diferente en cada
									// ejecuciÃ³n
	...
	public static String codifyJWT(Usuario u) {
		String jws = Jwts.builder().setSubject("" + u.getId()).signWith(SignatureAlgorithm.HS512, getGeneratedKey())
				.compact();
		return jws;
	}
